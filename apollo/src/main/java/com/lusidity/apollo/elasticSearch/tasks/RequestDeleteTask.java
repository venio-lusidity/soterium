...
public class RequestDeleteTask implements Callable<ResponseHandler>
{
	...
	// Constructors
	public RequestDeleteTask(DataVertex vertex, URL url, String... headers)
	{
		super();
		this.url=url;
		this.methods=HttpClientX.Methods.DELETE;
	...
	public ResponseHandler call()
		throws Exception
	{
		JsonData response=HttpClientX.getResponse(null, this.url, this.methods, this.referrer, this.headers);
