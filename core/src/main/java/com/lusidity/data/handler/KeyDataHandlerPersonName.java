...
public class KeyDataHandlerPersonName implements IKeyDataHandler
{
// Overrides
	@Override
	public KeyDataTransformed handleSetterBefore(Object newValue, KeyData keyData)
	{
		String result = null;
		if(null!=newValue){
			result = StringX.toTitle(newValue.toString());
		}
	...
	{
		Person person=(Person) keyData.getVertex();
		person.fetchTitle().setValue(person.getWesternName().toString());
	}
