...
public class KeyDataHandlerStringReplace implements IKeyDataHandler
{
	...
	public KeyDataHandlerStringReplace(String replacement, String... searchStrings){
		super();
	...
	public KeyDataTransformed handleSetterBefore(Object newValue, KeyData keyData)
	{
		...
		if(newValue instanceof String){
			...
			for(String str: this.searchStrings){
				result =StringX.replace(result, str, (null==this.replacement) ? "" : this.replacement);
			}
		}
