...
@AtSchemaClass(name="Anonymous User", discoverable=false)
public class AnonymousUser extends BasePrincipal
{
// Constructors
	...
	public AnonymousUser(JsonData dso, Object indexId)
	{
		super(dso, indexId);
	}
	...
	{
		return this.isAdmin(null, true);
	}

	@SuppressWarnings("UnusedParameters")
	public boolean isAdmin(DataVertex context, boolean validateCredentials)
	{
		return (null!=Environment.getInstance().getWebServer()) && !Environment.getInstance().getWebServer().credentialsRequired();
	}
