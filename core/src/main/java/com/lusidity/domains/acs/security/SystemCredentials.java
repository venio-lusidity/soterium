...
public class SystemCredentials implements UserCredentials
{
...
// Overrides
	...
	{
		return (obj instanceof SystemCredentials);
	}

	// Methods
	public static SystemCredentials getInstance()
	{
