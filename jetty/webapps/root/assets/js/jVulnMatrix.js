            ...
            html:{
                card: {
                    ...
                    load: function(){
                        ...
                        var width = Math.round((state.body.innerWidth() - dif) / 6);
                        width = (width < 20) ? 20 : width;
                        width =  (width % 2 === 0) ? width : width -1;

                        state.body.tbljVuln = $(document.createElement('table')).addClass('jVulnMatrix').css({
                            width: (width * 6) + 'px',
                            maxWidth: (width * 6) + 'px',
                            height: width + 'px',
                            verticalAlign: 'top',
                        ...
                        if (state.opts.css) {
                            state.body.tbljVuln.css(state.opts.css);
                        }
                        state.body.css({marginBottom: '10px'});
                        state.body.append(state.body.tbljVuln);
                        ...
                        state.body.tbljVuln.append(row);
