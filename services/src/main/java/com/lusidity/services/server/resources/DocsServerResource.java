...
@AtWebResource(pathTemplate = "/svc/downloads/docs", methods = "get", description = "Gives a response of pong and/or other information if available.")
@AtAuthorization(required = false, anonymous = true)
public class DocsServerResource
    ...
    public Representation retrieve(){
        ...
        String path = Environment.getInstance().getConfig().getDocsPath();
        ...
        if(null!=files){
            ...
            for(File file: files){
                if(file.isFile()){
                    ...
                    item.put("modified", (new DateTime(file.lastModified())).toString("dd MMM YYYY HH:mm:ss"));
